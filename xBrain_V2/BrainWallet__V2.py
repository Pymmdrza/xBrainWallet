...
for i in range(0 , len(mylist)) :
    ...
    txid = xTX(address)
    ifbtc = '0 BTC'
    print(Fore.RED , 'Check:' , Fore.WHITE , str(z) , Fore.RED , 'Win:' , Fore.WHITE , str(w) , Fore.RED ,
          ' Address:' , Fore.WHITE , str(address) , Fore.RED , ' TX:' , Fore.WHITE , str(txid))
    print(Fore.RED , 'PrivateKey:' , Fore.WHITE , str(private_key))
    print(
    ...
    if int(txid) > 0 :
        w += 1
        print(Fore.YELLOW , 'Check:' , Fore.WHITE , str(z) , Fore.YELLOW , 'Win:' , Fore.WHITE , str(w) , Fore.YELLOW ,
              'Value:' , Fore.WHITE , str(s) , Fore.YELLOW ,
        ...
        if str(bal) != str(ifbtc) :
            s += 1
            print(Fore.GREEN , 'Check:' , Fore.WHITE , str(z) , Fore.GREEN , 'Win:' , Fore.WHITE , str(w) ,Fore.BLUE ,'Value:' , Fore.WHITE , str(s) , Fore.YELLOW ,'\nAddress:' , Fore.RED , str(address) , Fore.GREEN , ' TX:' , Fore.WHITE , str(txid),Fore.WHITE,'Bal:',Fore.GREEN,str(bal))
            print(Fore.YELLOW , ' PrivateKey:' , Fore.RED , str(private_key))
            print('--------------------------------[MMDRZA.CoM]------------------------------')
